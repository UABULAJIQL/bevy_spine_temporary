...
impl SpineTextures {
    pub(crate) fn init() -> Self {
...

        {
            ...
            spine::extension::set_create_texture_cb(move |page, path| {
                data.lock().unwrap().remember.push(SpineTextureInternal {
                    path: path.to_owned(),
...

        {
            ...
            spine::extension::set_dispose_texture_cb(move |page| unsafe {
                data.lock().unwrap().forget.push(
